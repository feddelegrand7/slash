...
```
`slash` can operated on unnamed elements like above and/or on named elements like the following: 
...
Let's say we want to access the color of the __VW Golg__. While in standard `R` one can do: 
